...
These cells have the potential to enhance the library’s effeciency in applications such as fsm state retention, counters design, and control logic.

Read the full proposal [here](/docs/full_proposal)
